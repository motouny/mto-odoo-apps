...
export class ChromaHomeMenu extends Component {
    static template = "chroma_identity_theme.ChromaHomeMenu";
    static props = ["*"];
    ...
    accentClass(app) {
        return "o_chroma_accent_" + hashAccent(app.xmlid || app.id);
    }
...
registry.category("actions").add("chroma_identity_theme.home_menu", ChromaHomeMenu);
