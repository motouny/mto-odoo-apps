...
const STORAGE_KEY = "sa_dga_theme_font_scale";
const SCALES = ["", "o_dga_font_scale_lg", "o_dga_font_scale_xl"];
const LABELS = ["A", "A+", "A++"];
...
publicWidget.registry.DgaFontSizeAdjuster = publicWidget.Widget.extend({
    selector: "#wrapwrap",
    ...
    _renderControl() {
        if (document.querySelector(".o_dga_font_adjuster")) {
            return;
        }
        const container = document.createElement("div");
        container.className = "o_dga_font_adjuster";
...
export default publicWidget.registry.DgaFontSizeAdjuster;
